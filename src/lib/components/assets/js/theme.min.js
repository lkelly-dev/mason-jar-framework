var Demo = (function() {
    var n = document.querySelector('#demoForm'),
      ...
      p = (document.querySelectorAll('#stylesheetLight'),
      document.querySelector('#stylesheetLight')),
      h = null,
      b = localStorage.getItem('dashkitNavPosition')
        ? localStorage.getItem('dashkitNavPosition')
        : 'sidenav',
      v = localStorage.getItem('dashkitSidebarColor')
        ? localStorage.getItem('dashkitSidebarColor')
        : 'default';
    document.addEventListener('DOMContentLoaded', function() {
      var a, e, t, o, r, l;
      'light' == (a = colorScheme) ? (p.disabled = !1) : 'dark' == a && (p.disabled = !0),
        (function(a) {
          if (s && i && c && d)
            if ('topnav' == a) {
              t(i), t(c);
              for (var e = 0; e < u.length; e++)
                u[e].classList.remove('container-fluid'), u[e].classList.add('container');
            } else if ('combo' == a)
              for (t(s), t(d), e = 0; e < u.length; e++)
                u[e].classList.remove('container'), u[e].classList.add('container-fluid');
            else if ('sidenav' == a)
        ...
        c &&
          ('default' == e
            ? (c.classList.remove('navbar-dark', 'bg-vibrant'), c.classList.add('navbar-light'))
            : 'vibrant' == e &&
              (c.classList.remove('navbar-light'), c.classList.add('navbar-dark', 'bg-vibrant'))),
        (t = n),
        (o = colorScheme),
        (r = b),
        (l = v),
  ...
  ThemeCharts = (function() {
    var a,
      ...
      t = { base: 'Cerebri Sans' },
      o = {
        gray: { 300: '#E3EBF6', 600: '#95AAC9', 700: '#6E84A3', 800: '#152E4D', 900: '#283E59' },
          ...
          if (void 0 !== a.data('prefix') || void 0 !== a.data('prefix')) {
            ...
            (e.options.scales.yAxes[0].ticks.callback = function(a) {
              ...
              (e.options.tooltips.callbacks.label = function(a, e) {
                ...
                return (
                  1 < e.datasets.length &&
                    (r += '<span class="popover-body-label mr-auto">' + t + '</span>'),
                  (r += '<span class="popover-body-value">' + l + o + n + '</span>')
                );
              });
          }
        })(a, t),
    ...
    return (
        ...
        r(
          ...
          ((a = {
            defaults: {
              global: {
                ...
                defaultColor: 'dark' == colorScheme ? o.gray[700] : o.gray[600],
                defaultFontColor: 'dark' == colorScheme ? o.gray[700] : o.gray[600],
                ...
                elements: {
                  ...
                  arc: {
                    ...
                    borderColor: 'dark' == colorScheme ? o.gray[800] : o.white,
                    borderWidth: 4
                  }
                },
                tooltips: {
                  ...
                  custom: function(r) {
                    ...
                    if (
                      ...
                      var t = $(this._chart.canvas),
                        ...
                        d = o + r.caretY - c - 16,
                        u = s + r.caretX - i / 2;
                      a.css({ top: d + 'px', left: u + 'px', display: 'block' });
          ...
          Chart.scaleService.updateScaleDefaults('linear', {
            gridLines: {
              borderDash: [2],
              borderDashOffset: [2],
              color: 'dark' == colorScheme ? o.gray[900] : o.gray[300],
              drawBorder: !1,
              drawTicks: !1,
              lineWidth: 0,
              zeroLineWidth: 0,
              zeroLineColor: 'dark' == colorScheme ? o.gray[900] : o.gray[300],
      ...
      e.on({
        ...
        click: function() {
          var a = $(this);
          a.is('[data-update]') && n(a);
        }
      }),
      { colors: o, fonts: t, colorScheme: colorScheme }
    );
  })(),
  Header = (function() {
    var a,
          ...
          tooltips: {
            callbacks: {
              ...
              label: function(a, e) {
                var t = '';
                return (t +=
                  '<span class="popover-body-value">' + e.datasets[0].data[a.index] + '%</span>');
              }
            }
          }
        },
  ...
  Flatpickr = (function() {
    ...
    a.length &&
      a.each(function() {
        var a, e;
        (a = $(this)),
          (e = { mode: void 0 !== a.data('flatpickr-mode') ? a.data('flatpickr-mode') : 'single' }),
          a.flatpickr(e);
      });
  })(),
